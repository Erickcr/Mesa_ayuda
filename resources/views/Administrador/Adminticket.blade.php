                                                ...
                                                <td>
                                                    <div class="dropdown text-center">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <a class="dropdown-item" href="" type="button" data-toggle="modal" data-target="#exampleModal{{$nuevo->id}}">Eliminar</a>
                                                    ...
                                                    <form action="{{ route('borrar', $nuevo->id)}}" method="POST">
                                                        ...
                                                        <div class="modal fade" id="exampleModal{{$nuevo->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
